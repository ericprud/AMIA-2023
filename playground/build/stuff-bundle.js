(function (global, factory) {
	...
	*/
	...
	(function (module) {
		...
		class toRdf_rdvCh {
		  static toRdf_Prefixes = {fhirshex:''};
		  ...
		  processAbstractReference (contained, schemaObject, resourceType, inside = false) {
		    ...
		    const shapeForContained = this.shexj.shapes.find(se => se.id === toRdf_rdvCh.Prefixes.fhirshex + containedType);
		...
		class toRdf_RDVCh extends toRdf_rdvCh {
		...
		module.exports = { toRdf_rdvCh, toRdf_RDVCh }; 
	} (FhirJsonToRdf));
	...
	var stuff = {
	  ...
	  FhirPreprocessor: FhirJsonToRdfExports,
